...
use crate::task::{change_program_brk, current_user_token, exit_current_and_run_next, get_current_syscall_count, get_current_task_mut, suspend_current_and_run_next};
...
pub fn sys_mmap(start: usize, len: usize, prot: usize) -> isize {
    get_current_task_mut().mmap(start, len, prot)
}

// YOUR JOB: Implement munmap.
pub fn sys_munmap(start: usize, len: usize) -> isize {
    get_current_task_mut().munmap(start, len)
}
